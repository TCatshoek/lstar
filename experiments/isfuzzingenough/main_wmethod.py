...
from equivalencecheckers.wmethod import SmartWmethodEquivalenceCheckerV4, SmartWmethodEquivalenceCheckerV2
...
hyp = learner.run(
    ...
    on_hypothesis=savehypothesis(f'hypotheses/{problem}_wmethod', f'{problem}')
)
