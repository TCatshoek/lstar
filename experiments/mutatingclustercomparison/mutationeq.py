...
from equivalencecheckers.mutationeqchecker import MutationEquivalenceChecker
...
statstracker = StatsTracker({
    ...
    log_path=f'{problem}_mutation_nocluster.log',
...
def onct(ctex):
    ct.add(ctex)
    ct.save(f'counterexamples_{problem}_nocluster.p')
